...
import { ref } from 'vue'
import CloseCircleFilled from "@/Components/Icons/close-circle-filled.vue"
defineProps({
    projects: Object
})
...
function formatBytes(a, b = 2) {
    if (!+a) return "0 Bytes";
    const c = 0 > b ?
        0 : b, d = Math.floor(Math.log(a) / Math.log(1024));
                        ...
                        <div>
                            ...
                            <div class="mt-2 text-center">
                                <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white"
                                    id="modal-title">View Project</h3>
                ...
                <div class="">
                    <div
                        ...
                        <div>
                            ...
                            <div class="mt-2 text-center">
                                <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white"
                                    id="modal-title">Delete Project</h3>
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    ចង់មែន?
                                </p>
                            </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <section class="container px-4 mx-auto">
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <h2 class="text-lg font-medium text-gray-800 dark:text-white">All Projects</h2>
                                        ...
                                        <thead class="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                ...
                                                <th scope="col" class="relative py-3.5 px-4">
                                                    <span
                                                        class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Action</span>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody
                                            ...
                                            <tr v-for="project in projects.data" :key="project.id">
                                                    ...
                                                    <div class="inline-flex items-center gap-x-3">
                                                        ...
                                                        <div class="flex items-center gap-x-2">
                                                            <div
                                                                ...
                                                                <img v-preview :zoom="1.1" :src="project.image"
                                                ...
                                                <td>
                                                    ...
                                                    <button
                                                        class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm text-gray-500 hover:text-green-500 hover:shadow-lg hover:bg-gray-100 focus:relative">
                                                    ...
                                                    <button @click="handleViewProject"
                                                        class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm  text-gray-500 hover:text-blue-500 hover:shadow-lg hover:bg-gray-100 focus:relative">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                            class="h-4 w-4">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <button
                                                        class="inline-flex items-center gap-2 rounded-md  px-4 py-2 text-sm text-gray-500 hover:text-red-500 hover:shadow-lg hover:bg-gray-100 focus:relative ">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                            class="h-4 w-4">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
